...
Output of the ```cleaning_interpretive_word``` function:
```{r}
...
Output of the ```cleaning_interpretive_sentence``` function:
```{r}
...
Create a new directory ```outputs``` in the root folder if it does not exist and save it as CSV.
```{r}
# dir.create("../../outputs")
