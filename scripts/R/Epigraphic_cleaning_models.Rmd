...
write(EDH_clean_json, "../../outputs/EDH_clean_11_05_2020.json")
```
...
```{r}
number <- 37
print(Thracia$clean_text_interpretive[number])
print(Thracia$transcription[number])
print(Thracia$text_cleaned[number])
```


```{r}
print(Thracia$clean_text_interpretive[1:3])
```
